...
{		
	...
	/// </remarks>
	[CLSCompliant(true)]
	public partial class OrderProcessingTypeService : ZNode.Libraries.DataAccess.Service.OrderProcessingTypeServiceBase
	{
		/// <summary>
		/// Initializes a new instance of the OrderProcessingTypeService class.
		/// </summary>
		public OrderProcessingTypeService() : base()
		{
		}
