...
{		
	...
	/// </remarks>
	[CLSCompliant(true)]
	public partial class ShippingServiceCodeService : ZNode.Libraries.DataAccess.Service.ShippingServiceCodeServiceBase
	{
		/// <summary>
		/// Initializes a new instance of the ShippingServiceCodeService class.
		/// </summary>
		public ShippingServiceCodeService() : base()
		{
		}
