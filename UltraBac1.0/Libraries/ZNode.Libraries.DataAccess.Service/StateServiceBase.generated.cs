...
{		
	...
	public partial class StateServiceBase : ServiceBase<State, StateKey>
	{
		...
		public static State CreateState(System.String code, System.String countryCode, System.String name)
		{
			State newEntityState = new State();
			newEntityState.Code  = code;
			newEntityState.CountryCode  = countryCode;
			newEntityState.Name  = name;
		...
		/// <summary>
		///  method that Gets rows in a <see cref="TList{State}" /> from the datasource based on the primary key PK_ZNodeState index.
		/// </summary>
		/// <param name="code"></param>
		/// <returns>Returns an instance of the <see cref="State"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual State GetByCode(System.String code)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="State"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual State GetByCode(System.String code, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.StateProvider.GetByCode(transactionManager, code, start, pageLength, out totalCount)   as State;
		...
		/// <returns>Returns a typed collection of <c>State</c> objects.</returns>
		public virtual TList<State> Find(SqlFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>State</c> objects.</returns>
		public virtual TList<State> Find(SqlFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>State</c> objects.</returns>
		public virtual TList<State> Find(SqlFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual State Save(State entity)
		{
			// throws security exception if not authorized
		...
		public virtual bool Delete(System.String code)
		{
			...
			try
            {
				...
				//Delete
				result = dataProvider.StateProvider.Delete(transactionManager, code);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual State DeepLoadByCode(System.String code, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByCode");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			State entity = GetByCode(code);
		...
		/// <param name="entity">State Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(State entity)
		{
