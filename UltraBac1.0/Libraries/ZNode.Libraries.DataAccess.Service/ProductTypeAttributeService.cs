...
{		
	...
	/// </remarks>
	[CLSCompliant(true)]
	public partial class ProductTypeAttributeService : ZNode.Libraries.DataAccess.Service.ProductTypeAttributeServiceBase
	{
		/// <summary>
		/// Initializes a new instance of the ProductTypeAttributeService class.
		/// </summary>
		public ProductTypeAttributeService() : base()
		{
		}
