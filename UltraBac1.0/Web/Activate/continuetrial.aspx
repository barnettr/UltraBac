...
<asp:Content ID="Content1" ContentPlaceHolderID="uxMainContent" Runat="Server">
    <div class="License">
        ...
        <div class="ActionLink" style="margin-left:50px; margin-bottom:20px;"><b><img id="Img3" src="~/images/icons/16/400-right.gif" border="0" align="absmiddle" runat="server" />  <a id="A2" href="~/default.aspx" runat="server">Continue with Trial</a></b></div> 
