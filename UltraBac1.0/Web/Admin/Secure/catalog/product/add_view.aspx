...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="uxMainContent">
    <div class="Form">
        ...
        <small>This Product Image will be displayed on the product page as a thumbnail. Your customers can click on this thumbnail to see a larger version. Use this image to show different views of your product</small>       
...
<%--            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txttitle"
                Display="Dynamic" ErrorMessage="* Enter a Title" SetFocusOnError="True" CssClass="Error"></asp:RequiredFieldValidator>
--%>        </div>
        <div class="ValueStyle">
            <asp:TextBox ID="txttitle" runat="server" Columns="30" MaxLength="30"></asp:TextBox>
        </div>
        <div class="FieldStyle">
            Image<span class="Asterix">*</span>
        </div>
    ...
    Image File Name
    <div class="ValueStyle">
    <asp:TextBox ID="txtimagename" runat="server" Visible="false" Columns="30" MaxLength="30"></asp:TextBox></div>
    </div>
    ...
    <table  id="tblProductDescription" border="0" cellpadding="0" cellspacing="0" width="100%" runat="server" visible="false">
        ...
        <div class="FieldStyle">Display Product Image?</div>
	    <div class="ValueStyle"><asp:CheckBox ID='VisibleInd' runat='server' Checked="true" Text="Check this box to show this product image" ></asp:CheckBox></div><br />
