...
<div class="Form">
	...
	<p>Use this page to manage the products in your catalog. You can also add related items, images, add-ons and inventory to your products</p> 
    ...
    <asp:GridView ID="uxGrid" runat="server" CssClass="Grid" CaptionAlign="Left" AutoGenerateColumns="False" GridLines="None"  AllowPaging="True" PageSize="10" OnPageIndexChanging="uxGrid_PageIndexChanging" OnRowCommand="uxGrid_RowCommand" EmptyDataText="No Products exist in the database." Width="100%" CellPadding="4">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Image">
                ...
                <img alt=" " src='<%#  ZNode.Libraries.Framework.Business.ZNodeConfigManager.EnvironmentConfig.ThumbnailImagePath + DataBinder.Eval(Container.DataItem, "ImageFile").ToString()%>' runat="server" style="border:none" />
                </a>
                </ItemTemplate>
            </asp:TemplateField>
            
            <asp:HyperLinkField DataNavigateUrlFields="productid" DataNavigateUrlFormatString="view.aspx?itemid={0}"
                DataTextField="name" HeaderText="Title" />
