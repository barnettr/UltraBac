...
<asp:Content ID="Content1" ContentPlaceHolderID="uxMainContent" Runat="Server">
    <div class="Form">
        ...
        <div><asp:requiredfieldvalidator id="Requiredfieldvalidator2" runat="server" Display="Dynamic" ErrorMessage="* You Must Enter a Valid Display Order"
        ...
        <div class="ValueStyle"><asp:TextBox ID="DisplayOrder" runat="server" MaxLength="3" Columns="5">1</asp:TextBox>&nbsp;
            <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="DisplayOrder"
                Display="Dynamic" ErrorMessage="* Enter a number between 0-100" MaximumValue="100"
                MinimumValue="0" Type="Integer"></asp:RangeValidator></div>
