...
<asp:Content ID="Content1" ContentPlaceHolderID="uxMainContent" Runat="Server">
    ...
    <p>Please confirm if you want to delete the Product Type titled <b>"<%=ProductCategoryName%>"</b>.
        Note that this will also delete all the products of this Type. This change cannot be undone.
        <asp:Label ID="lblError" runat="server" Width="450px" CssClass="Error"></asp:Label></p>
