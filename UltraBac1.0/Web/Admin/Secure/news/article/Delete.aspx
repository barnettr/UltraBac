<%@ Page Language="C#" MasterPageFile="~/Admin/Themes/Standard/edit.master" AutoEventWireup="true" CodeFile="Delete.aspx.cs" Inherits="Admin_Secure_News_Article_Delete" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="uxMainContent" Runat="Server">
    ...
    <p>Please confirm that you want to delete the article named <b>"<%= Title %>"</b>. Note that this change cannot be undone.</p>
