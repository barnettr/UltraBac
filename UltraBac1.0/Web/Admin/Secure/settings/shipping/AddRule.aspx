...
<div class="Form">
        ...
        <p>Enter the base cost which is applied irrespective of the number of items.</p>
 	    ...
 	    <div><asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="txtBaseCost" Type="Currency" Display="Dynamic" Operator="DataTypeCheck" ErrorMessage="You must enter a valid base cost (ex: 123.45)" /> </div>
        <div class="ValueStyle"><span class="DollarSymbol">$ </span><asp:TextBox ID="txtBaseCost" runat="server">0.00</asp:TextBox></div>
     
        <div class="FieldStyle">Per Item Cost</div>
        <p>Enter the shipping cost to be applied to each item in the order</p>
        ...
        <div><asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="txtPerItemCost" Type="Currency" Display="Dynamic"  Operator="DataTypeCheck" ErrorMessage="You must enter a valid per-item cost (ex: 123.45)" /></div>
        <div class="ValueStyle"><span class="DollarSymbol">$ </span><asp:TextBox ID="txtPerItemCost" runat="server">0.00</asp:TextBox></div>
        ...
        <asp:Panel ID="pnlNonFlat" runat="server" Visible="false"> 	
            ...
            <div class="ValueStyle"><asp:TextBox ID="txtUpperLimit" runat="server">0.00</asp:TextBox></div>
        </asp:Panel>
