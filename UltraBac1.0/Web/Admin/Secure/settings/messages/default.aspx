...
<asp:Content ID="Content1" ContentPlaceHolderID="uxMainContent" Runat="Server">
    <asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="../../../../Data/Default/Config/MessageConfig.xml" ></asp:XmlDataSource>
    ...
    <div class="Form">
        ...
        <h4>List of Custom Messages</h4>
        <asp:GridView ID="uxGrid" runat="server" PageSize="100" CssClass="Grid" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" OnRowCommand="uxGrid_RowCommand" GridLines="None" CaptionAlign="Left" Width="100%" AllowSorting="True" EmptyDataText="No custom messages available." DataSourceID="XmlDataSource1">
