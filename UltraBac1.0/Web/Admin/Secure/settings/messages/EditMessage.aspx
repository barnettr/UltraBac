<%@ Page Language="C#" MasterPageFile="~/Admin/Themes/Standard/content.master" AutoEventWireup="true" CodeFile="EditMessage.aspx.cs" Inherits="Admin_Secure_settings_messages_EditMessage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="uxMainContent" Runat="Server">
    ...
    <h1><asp:Label ID="lbltitle" runat="server"></asp:Label></h1><br />
	    ...
	    <br />		   
	    <div><asp:Label ID="lblmsg" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label></div>    
