<%@ Page Language="C#" MasterPageFile="~/Admin/Themes/Standard/edit.master" AutoEventWireup="true" CodeFile="CSSEditor.aspx.cs" Inherits="Admin_Secure_template_CSSEditor" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="uxMainContent">
    <div class="Form">
        <table width="100%" cellspacing="0" cellpadding="0" >
		    <tr>
			    <td><h1>Edit Stylesheet<uc2:DemoMode ID="DemoMode1" runat="server" />
                </h1></td>
			    <td align="right">
