<%@ Page Language="C#"  MasterPageFile="~/Admin/Themes/Standard/content.master" AutoEventWireup="true" CodeFile="view.aspx.cs" Inherits="Admin_Secure_cases_view" %>
...
<div class="Form">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="ViewForm">
        ...
        <tr class="RowStyle">
            ...
            <td class="ValueStyle">                            
                                   <asp:TextBox runat="server" ReadOnly="true" ID="txtCaseDescription" Height="59px" TextMode="MultiLine" />
            </td>
        </tr> 
    </table>
