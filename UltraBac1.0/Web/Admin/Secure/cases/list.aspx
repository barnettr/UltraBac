<%@ Page Language="C#" MasterPageFile="~/Admin/Themes/Standard/content.master"   AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="Admin_Secure_cases_list" %>
...
<div class="Form">
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td>
                ...
                Use this page to manage customer service requests submitted using the Contact-Us form. You can also create service requests manually.              
            </td>
    ...
    <asp:GridView id="uxGrid" runat="server" CssClass="Grid" Width="100%" AllowSorting="True" CellPadding="4" DataKeyNames="accountid" EmptyDataText="No Cases exist in the database." OnRowCommand="uxGrid_RowCommand" OnPageIndexChanging="uxGrid_PageIndexChanging" PageSize="50" AllowPaging="True" GridLines="None" AutoGenerateColumns="False" CaptionAlign="Left">
        <Columns>
            <asp:HyperLinkField SortExpression="CaseID" HeaderText="Case ID" DataTextField="CaseID" DataNavigateUrlFormatString="~/admin/secure/cases/view.aspx?itemid={0}" DataNavigateUrlFields="caseid" />
            <asp:HyperLinkField HeaderText="Title" DataTextField="Title" DataNavigateUrlFormatString="~/admin/secure/cases/view.aspx?itemid={0}" DataNavigateUrlFields="CaseID" />
