...
public partial class Admin_Secure_cases_view : System.Web.UI.Page
{

    # region Protected Member Variables
        protected int ItemID = 0;
        protected string listLink = "~/admin/secure/cases/list.aspx";
        ...
        protected string AddNoteLink = "~/admin/secure/cases/note_add.aspx?itemid=";
    # endregion
