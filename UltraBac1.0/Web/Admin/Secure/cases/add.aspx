<%@ Page Language="C#" MasterPageFile="~/Admin/Themes/Standard/edit.master"  AutoEventWireup="true" CodeFile="add.aspx.cs" Inherits="Admin_Secure_cases_Default" %>
...
<div class="Form">
        ...
        <div class="FieldStyle">Case priority</div>
        <div class="ValueStyle"><asp:DropDownList ID="lstCasePriority" runat="server"></asp:DropDownList></div>       	
        
        <div class="FieldStyle">Case Title<span class="Asterix">*</span></div>
        ...
        <div class="ValueStyle"><asp:TextBox ID="txtCaseTitle" runat="server" MaxLength="50" Columns="20"></asp:TextBox></div>
 	    ...
 	    <div class="FieldStyle">Case Description<span class="Asterix">*</span></div>
 	    ...
 	    <div class="ValueStyle"><asp:TextBox ID="txtCaseDescription" runat="server" TextMode="MultiLine" Height="190px" MaxLength="10000" Width="354px"></asp:TextBox></div>
